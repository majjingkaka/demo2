...
import com.soulinku.demo2.util.CamelHashMap;

import javax.sql.DataSource;

@Configuration
@Import(DbConfig.class)
@MapperScan(basePackages = "com.soulinku.demo2.mapper")
public class MybatiseConfig {
    ...
    */
    ...
    public SqlSessionFactory sqlSessionFactory(DataSource dataSource) throws Exception{
        ...
        sqlSessionFactoryBean.setTypeAliasesPackage("com.soulinku.demo2.dto");
